            ...
            if (targets.length > 0) {
                targets.sort(function (a, b) {
                    ...
                    if (a.structureType == STRUCTURE_CONTAINER) {
                        refillRelevanceA += a.store[RESOURCE_ENERGY] / creep.pos.getRangeTo(a);
                    } else {
                        refillRelevanceA += a.energy / creep.pos.getRangeTo(a);;
                    }

                    if (b.structureType == STRUCTURE_CONTAINER) {
                        refillRelevanceA += b.store[RESOURCE_ENERGY] / creep.pos.getRangeTo(b);
                    } else {
                        refillRelevanceA += b.energy / creep.pos.getRangeTo(b);;
                    }
